...
LIGHT_WALLPAPER="${LIGHT_WALLPAPER:-$WALLPAPER_DIR/Serene Japanese Landscape with Red Trees.jpg}"
DARK_WALLPAPER="${DARK_WALLPAPER:-$WALLPAPER_DIR/ChatGPT Image 9 авг. 2026 г., 20_48_49.png}"
