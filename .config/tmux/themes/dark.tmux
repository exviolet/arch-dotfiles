...
set -g status-left "#[fg=#D14D41,bg=#100F0F,bold] #(whoami)  #[fg=#343331] "
...
set -g status-right "#[fg=#FFFCF0,bg=#100F0F] %H:%M #[fg=#343331] #[fg=#FFFCF0] %Y-%m-%d #[fg=#343331] #[fg=#D14D41,bold] #S "
set -g pane-active-border-style "fg=#D14D41"
set -g pane-border-style "fg=#343331"
set -g message-style "bg=#1C1B1A,fg=#FFFCF0"
set -g mode-style "bg=#4385BE,fg=#100F0F,bold"
