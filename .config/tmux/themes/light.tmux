...
set -g status-left "#[fg=#205EA6,bg=#E6E4D9,bold] #(whoami)  #[fg=#DAD8CE] "
...
set -g status-right "#[fg=#100F0F,bg=#E6E4D9] %H:%M #[fg=#DAD8CE] #[fg=#100F0F] %Y-%m-%d #[fg=#DAD8CE] #[fg=#205EA6,bold] #S "
